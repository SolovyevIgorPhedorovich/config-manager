        ...
        >
            ...
            >
                <Tabs defaultActiveKey="basic" type="card">
                    ...
                    <Tabs.TabPane tab="Основные настройки" key="basic">
                        ...
                        <Divider orientation="vertical">Физические параметры</Divider>
                        <Space wrap>
                    ...
                    {/* Вкладка "Настройки портов" (VLAN, Trunk/Access) */}
                    <Tabs.TabPane tab="Настройки портов" key="port">
                        <Form.Item
                            label="Интерфейс(ы)"
                            name="interfaceNames"
                    ...
                    <Tabs.TabPane tab="Безопасность" key="security">
                        <Form.Item label="Port Security" name="enablePortSecurity" valuePropName="checked">
                            <Switch />
                        </Form.Item>

                        <Collapse ghost>
                            <Collapse.Panel header="Дополнительные настройки безопасности" key="1">
                        ...
                        <Divider orientation="vertical">BPDU Guard / Filter (опционально)</Divider>
