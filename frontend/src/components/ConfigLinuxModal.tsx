import { Button, Form, InputNumber, Modal, Select, Switch, message, Input, Tabs, Divider, Checkbox, Space } from 'antd';
            ...
            >
                <Tabs activeKey={activeTab} onChange={setActiveTab}>
                    <TabPane tab="Система" key="system">
                        ...
                        {form.getFieldValue('autoUpgrade') && (
