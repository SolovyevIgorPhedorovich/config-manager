...
import com.project.configmanager.config.command.LinuxConfigCommandGenerator;
import com.project.configmanager.config.command.WindowsConfigCommandGenerator;
import com.project.configmanager.config.dto.DeviceCredentials;
import com.project.configmanager.config.event.ConfigApplyEvent;
...
import com.project.configmanager.service.RemoteCommandService;
...
public class ConfigOrchestrationService {
    ...
    public List<String> applyConfiguration(List<DeviceInfo> devices, JsonNode newConfig,
